...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabSelectTextColor = 0xFF333333;
    ...
    private int oneScreenShowSize = 0;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        oneScreenShowSize = a.getInteger(R.styleable.PagerSlidingTabStrip_pstsOneScreenTabs, oneScreenShowSize);
        ...
        if (oneScreenShowSize > 0) {
            width = mScreenWidth / oneScreenShowSize;
        }
    ...
    private void updateTabStyles() {
        ...
        setCurrentTabTextColor(selectedPosition);
    }
    ...
    private void setCurrentTabTextColor(int position) {
        ...
        if (v1 != null && v1 instanceof TextView) {
            ...
            TextView tab1 = (TextView) v1;
            tab1.setTextColor(tabSelectTextColor);
        }
    }

    /**
     * 设置一屏幕显示固定个数tab,默认自适应
     *
     * @param tabNums 显示个数
     */
    public void setShowFixTabsOneScreen(int tabNums) {
        int width = LayoutParams.WRAP_CONTENT;
        if (tabNums > 0) {
            width = mScreenWidth / tabNums;
        }
        defaultTabLayoutParams = new LinearLayout.LayoutParams(width, LayoutParams.MATCH_PARENT);
